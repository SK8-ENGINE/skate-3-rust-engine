...
///Accepted-target publication82D6AEA4..82D6AF38. The original contact
...
pub fn apply_admitted_target(
    ...
    super::launch::adjust_trajectory(
...
pub fn landing_normal(
    ...
    normalize(sub(limited, scale(direction, dot(limited, direction))))
}
...
pub fn admitted_displacement(
    ...
    if candidate.distance >= lock_distance.max(0.1) {
        return None;
    }
