...
on each PC for that mod's shared objects. Launch `PLAY-MARIO-KART.bat`, then use
...
available. `Build-VehicleSDK.ps1` builds and stages both executables without launching them.
