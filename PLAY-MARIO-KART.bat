...
if not exist "%~dp0.local\vehicle-sdk\skate3-vehicle-animations.exe" (
...
"%~dp0.local\vehicle-sdk\skate3-vehicle-animations.exe" --assets "%SKATE3_ASSETS%" --start-paused %* > "%~dp0.local\vehicle-sdk\session.log" 2>&1
